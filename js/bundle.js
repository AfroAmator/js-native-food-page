...
function cards() {
  var MenuCard = /*#__PURE__*/function () {
    function MenuCard(img, alt, menu, describe, price, parentSelector) {
    ...
    _createClass(MenuCard, [{
      ...
      value: function currencyConverter(usd, usdToUah) {
        return usd * usdToUah;
      }
    }, {
      key: "createCard",
  ...
  Object(_services_services__WEBPACK_IMPORTED_MODULE_3__["getSomeData"])('http://localhost:3000/menu').then(function (data) {
...
function modal(triggerSelector, modalSelector, modalTimerId) {
  var modalOpenTrigger = document.querySelectorAll(triggerSelector),
      modal = document.querySelector(modalSelector);
  modalOpenTrigger.forEach(function (item) {
...
function request(formSelector, modalTimerId) {
  ...
  function showThanksModal(message) {
    var prevModalWindow = document.querySelector('.modal__dialog');
...
function slides(_ref) {
  ...
  if (slides.length < 10) {
    slidesTotal.textContent = "0".concat(slides.length);
    slidesCurrent.textContent = "0".concat(index);
  } else {
  ...
  dotsArr.forEach(function (dot) {
    dot.addEventListener('click', function (event) {
      var moveTo = event.target.getAttribute('data-slide-to');
      index = moveTo;
...
function timer(timerSelector, dateEnd) {
  function setTimer(dat) {
    var timerWorkTime = Date.parse(dat) - new Date(),
  ...
  function setClock(selector, endtime) {
    ...
    function updateClock() {
      var timeUpdate = setTimer(endtime);
...
var getSomeData = /*#__PURE__*/function () {
  ...
  return function getSomeData(_x3) {
